...
public class ClassroomFragment extends Fragment implements View.OnClickListener{
    ...
    public void startStorylineThread() {
        ...
        nullAnimator4.setDuration(6000);
        ...
        nullAnimator9.setDuration(6000);
